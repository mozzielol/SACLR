...
from attention.saliency_map import Saliency_vgg
from models.clustering import Sim_cluster
...
class VGG16(nn.Module):
    ...
    def forward(self, x):
        ...
        # fore_attention = self.saliency_map_1(out)
        # back_attention = self.saliency_map_2(out)
        ...
        out = F.relu(out)
        return self.cluster(out), out
        # out = self.maxpool5(out)  # 7
        # foreground, background = self.project(out * fore_attention), \
        #                          self.project(out * back_attention)
        #
